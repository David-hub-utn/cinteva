...
<!--termina validación -->
 ...
 <table align="center"  bgcolor="white" bordercolor="#000000">
        <tr>
        <th colspan="1"><a href="pel_ALTAS.php">NUEVO ALUMNO</a></th>
...
$datos= $conexion00->query("SELECT * FROM alumno");
   ...
   //echo $user['ALU_NOMBRE'];
    ...
    <tr>
        <td><?php echo $row['ALU_NOMBRE']; ?></td>
            <td><?php echo $row['ALU_APP']; ?></td>
            <td><?php echo $row['ALU_APM']; ?></td>
            <td><?php echo $row['GRUPO_ID']; ?></td>
            <td><?php echo $row['ALU_CORREO']; ?></td>
            <td><?php echo $row['ALU_CONTRASEÑA']; ?></td>
             <td><?php echo $row['ALU_STATUS']; ?></td>
          
           
            <td><a href="modificar_alu.php?ALU_ID=<?php echo $row['ALU_ID']; ?>">Modificar</a></td>
            <td><a href="eliminar_alu.php?pel_ID=<?php echo $row['pel_ID']; ?>">Eliminar</a></td>
