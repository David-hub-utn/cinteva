...
<!--termina validación -->
  ...
  <body>
    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <!-- <li class="rd-nav-item"><a class="rd-nav-link" href="../logout.php" style="color: #50ba87;">Cerrar sesión</a>
                      </li> -->
                      <li class="rd-nav-item"><a class="rd-nav-link" href="../index.html">Volver al inicio</a>
                      </li>
                    </ul>
      ...
      <!-- Breadcrumbs -->
      <section class="breadcrumbs-custom-inset"></section>
    <div class="container">
        <br><br>
        <br><br>
...
<form>
<input type="text" required name="ALU_NOMBRE" placeholder="NOMBRE" value="
<?php echo $row['ALU_NOMBRE'];?>" /><br/>
<input type="text" required name="ALU_APP" placeholder="APELLIDO PATERNO" value="
<?php echo $row['ALU_APP'];?>" /><br/>
<input type="text" required name="ALU_APM" placeholder="APELLIDO MATERNO" value="
<?php echo $row['ALU_APM'];?>" /><br/>
<input type="text" required name="GRUPO_ID" placeholder="APELLIDO GRUPO" value="
<?php echo $row['GRUPO_ID'];?>" /><br/>
<input type="text" required name="ALU_CORREO" placeholder="APELLIDO CORREO" value="
<?php echo $row['ALU_CORREO'];?>" /><br/>
<input type="text" required name="ALU_CONTRASEÑA" placeholder="APELLIDO CONTRASEÑA" value="
<?php echo $row['ALU_CONTRASEÑA'];?>" /><br/>
