        ...
        <section class="breadcrumbs-custom-inset">
            <div class="container">
                ...
                <div style="display: flex; justify-content: center;">
                    <form action="log_prof_php.php"  class="fh5co-form animate-box" data-animate-effect="fadeIn"
                        method="post" onsubmit="return validar();" >

                            <input type="email" class="form-control" id="PROF_CORREO" name="PROF_CORREO"
                                placeholder="&#9000;Usuario" autocomplete="off" required style="width:350px;font-size:15px;">
                            <br>
                            <input type="password" class="form-control" id="PROF_CONTRASEÑA" name="PROF_CONTRASEÑA"
                                placeholder="&#128272;Contraseña" autocomplete="off" required style="width:350px;font-size:15px;">
                                <br>
