...
.portada{
    background: url(../images/historia_mexico.jpg) no-repeat fixed center;
...
<body>
    ...
    <div class="page">
        ...
        <div class="portada">
            <div class="text">
                <h1 style="color: white;">Profesor<br>Iniciar Sesión</h1>
                <br><br>

                <div style="display: flex; justify-content: center;">
                    <form action="log_prof_php.php" name="form1" id="form1" class="fh5co-form animate-box" data-animate-effect="fadeIn"
